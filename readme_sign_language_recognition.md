...
2. Ensure dataset is available in Google Drive
...
## ⭐ Note
This project is intended for **learning and academic purposes**, demonstrating how deep learning can be applied to real-world computer vision problems like sign language recognition.
